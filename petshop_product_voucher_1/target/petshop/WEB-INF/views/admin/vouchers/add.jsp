...
<t:admin_layout title="Thêm Khuyến Mãi Mới" pageHeader="Thêm Khuyến Mãi Mới">
    <jsp:body>
        ...
        <form action="${pageContext.request.contextPath}/admin/vouchers/insert" method="post" onsubmit="return validateDates()">
